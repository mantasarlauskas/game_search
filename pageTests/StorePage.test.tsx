...
import StorePage, { getServerSideProps } from 'pages/stores/[id]';
...
describe('<StorePage />', () => {
    ...
    it('matches snapshot', () => {
        const { container } = render(<StorePage {...props} />);
        expect(container).toMatchSnapshot();
    });

    it('shows content', () => {
        render(<StorePage {...props} />);
        expect(screen.getByText('Games available on Feral Interactive')).toBeInTheDocument();
